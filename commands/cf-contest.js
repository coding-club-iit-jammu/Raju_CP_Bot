...
const getContests = require("../lib/cf/api").getContests;

/**
 * command usage: retrives contests yet to start & User can filter based
 * on division
 * usage:
 *   !cf-contest [division]
...
module.exports = {
  ...
  usage: "[division]",
  description:
    "Retrieve list of yet to start contests filtered by" +
